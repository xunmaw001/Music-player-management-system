...
public class HuiyuangoumaiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,HuiyuangoumaiEntity huiyuangoumai, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("huiyuanxinxi")) {
			huiyuangoumai.setHuiyuanhao((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,HuiyuangoumaiEntity huiyuangoumai, HttpServletRequest request){
        EntityWrapper<HuiyuangoumaiEntity> ew = new EntityWrapper<HuiyuangoumaiEntity>();
		PageUtils page = huiyuangoumaiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, huiyuangoumai), params), params));
        return R.ok().put("data", page);
    }
