...
public class YinlefenleiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,YinlefenleiEntity yinlefenlei, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,YinlefenleiEntity yinlefenlei, HttpServletRequest request){
        EntityWrapper<YinlefenleiEntity> ew = new EntityWrapper<YinlefenleiEntity>();
		PageUtils page = yinlefenleiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, yinlefenlei), params), params));
        return R.ok().put("data", page);
    }
    ...
    public R save(@RequestBody YinlefenleiEntity yinlefenlei, HttpServletRequest request){
    	yinlefenlei.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
    ...
    public R update(@RequestBody YinlefenleiEntity yinlefenlei, HttpServletRequest request){
        //ValidatorUtils.validateEntity(yinlefenlei);
        yinlefenleiService.updateById(yinlefenlei);//全部更新
        return R.ok();
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<YinlefenleiEntity> wrapper = new EntityWrapper<YinlefenleiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = yinlefenleiService.selectCount(wrapper);
