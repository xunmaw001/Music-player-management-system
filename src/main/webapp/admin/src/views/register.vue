  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(225, 225, 225, 1);borderRadius:26px">
        <h1 class="h1" style="color:rgba(244, 91, 75, 1);fontSize:28px;">音乐播放器管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机" type="text" />
																														...
																														<!-- <div v-if="tableName=='huiyuanxinxi'" class="input-group">
			   <div class="label">用户名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.yonghuming" class="input" type="text" placeholder="用户名">
			   </div>
			 </div> -->
			<el-form-item label="用户名" class="input" v-if="tableName=='huiyuanxinxi'">
			  <el-input v-model="ruleForm.yonghuming" autocomplete="off" placeholder="用户名" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='huiyuanxinxi'" class="input-group">
			   <div class="label">昵称</div>
			...
			<el-form-item label="昵称" class="input" v-if="tableName=='huiyuanxinxi'">
			  <el-input v-model="ruleForm.nicheng" autocomplete="off" placeholder="昵称" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='huiyuanxinxi'" class="input-group">
			...
			<el-form-item label="会员号" class="input" v-if="tableName=='huiyuanxinxi'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='huiyuanxinxi'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='huiyuanxinxi'" class="input-group">
			   <div class="label">姓名</div>
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='huiyuanxinxi'">
			  <el-input v-model="ruleForm.xingming" autocomplete="off" placeholder="姓名" type="text" />
			</el-form-item>
																					<!-- <div v-if="tableName=='huiyuanxinxi'" class="input-group">
			   <div class="label">价格</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiage" class="input" type="text" placeholder="价格">
			   </div>
			 </div> -->
			<el-form-item label="价格" class="input" v-if="tableName=='huiyuanxinxi'">
			  <el-input v-model="ruleForm.jiage" autocomplete="off" placeholder="价格" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='huiyuanxinxi'" class="input-group">
			   <div class="label">有效时间</div>
			   <div class="input-container">
			     <input v-model="ruleForm.youxiaoshijian" class="input" type="text" placeholder="有效时间">
			   </div>
			 </div> -->
			<el-form-item label="有效时间" class="input" v-if="tableName=='huiyuanxinxi'">
			  <el-input v-model="ruleForm.youxiaoshijian" autocomplete="off" placeholder="有效时间" type="text" />
			</el-form-item>
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        if((!this.ruleForm.huiyuanhao) && `huiyuanxinxi` == this.tableName){
        this.$message.error(`会员号不能为空`);
        return
      }
                                                            if((!this.ruleForm.mima) && `huiyuanxinxi` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
                                                                                                            if((!this.ruleForm.huiyuanleibie) && `huiyuanxinxi` == this.tableName){
        this.$message.error(`会员类别不能为空`);
        return
      }
                                                                                                                                                            if((!this.ruleForm.kaitongriqi) && `huiyuanxinxi` == this.tableName){
        this.$message.error(`开通日期不能为空`);
        return
      }
                                                            if((!this.ruleForm.daoqiriqi) && `huiyuanxinxi` == this.tableName){
