  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="会员类别" prop="huiyuanleibie">
          <el-select  @change="huiyuanleibieChange" v-model="ruleForm.huiyuanleibie" placeholder="请选择会员类别">
            <el-option
                v-for="(item,index) in huiyuanleibieOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.huiyuanleibie" label="会员类别" prop="huiyuanleibie">
              <el-input v-model="ruleForm.huiyuanleibie" 
                placeholder="会员类别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="价格" prop="jiage">
              <el-input v-model="ruleForm.jiage" 
                placeholder="价格" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="有效时间" prop="youxiaoshijian">
          <el-input v-model="ruleForm.youxiaoshijian" 
              placeholder="有效时间" clearable  :readonly="ro.youxiaoshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="有效时间" prop="youxiaoshijian">
              <el-input v-model="ruleForm.youxiaoshijian" 
                placeholder="有效时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="开通日期" prop="kaitongriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.kaitongriqi" 
                type="date"
                placeholder="开通日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.kaitongriqi" label="开通日期" prop="kaitongriqi">
              <el-input v-model="ruleForm.kaitongriqi" 
                placeholder="开通日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  data() {
	...
	ispay : false,
            ...
            ruleForm: {
                  ...
                  huiyuanleibie: [
                            { required: true, message: '会员类别不能为空', trigger: 'blur' },
                                    	                                                              ],
                  jiage: [
                                    	                                                              ],
                  youxiaoshijian: [
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
            continue;
	            	            ...
	            	            if(o=='huiyuanleibie'){
            this.ruleForm.huiyuanleibie = obj[o];
	    this.ro.huiyuanleibie = true;
            continue;
          }
	            	            if(o=='jiage'){
	    ...
	    this.ro.youxiaoshijian = true;
            continue;
	            	            ...
	            	            if(o=='kaitongriqi'){
            this.ruleForm.kaitongriqi = obj[o];
	    this.ro.kaitongriqi = true;
            continue;
          }
	            	            if(o=='daoqiriqi'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                                    ...
                                                                                                                                    this.$http({
              url: `option/huiyuanleibie/huiyuanleibie`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.huiyuanleibieOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
    ...
    huiyuanleibieChange () {
      this.$http({
        url: `follow/huiyuanleibie/huiyuanleibie?columnValue=`+ this.ruleForm.huiyuanleibie,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
                                                                                                                                                                        if(data.data.jiage){
