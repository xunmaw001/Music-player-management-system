          ...
          <el-form-item class="input" label="分类" prop="fenlei">
              <el-input v-model="ruleForm.fenlei" 
                placeholder="分类" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="音乐文件" prop="yinlewenjian">
          <file-upload
          tip="点击上传音乐文件"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.yinlewenjian?ruleForm.yinlewenjian:''"
          @change="yinlewenjianUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.yinlewenjian" label="音乐文件" prop="yinlewenjian">
            <el-button type="text" size="small" @click="download(ruleForm.yinlewenjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="音质" prop="yinzhi">
          <el-input v-model="ruleForm.yinzhi" 
              placeholder="音质" clearable  :readonly="ro.yinzhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="音质" prop="yinzhi">
              <el-input v-model="ruleForm.yinzhi" 
                placeholder="音质" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fenlei = true;
            continue;
	            	            ...
	            	            if(o=='yinlewenjian'){
            this.ruleForm.yinlewenjian = obj[o];
	    this.ro.yinlewenjian = true;
            continue;
          }
	            	            if(o=='yinzhi'){
            this.ruleForm.yinzhi = obj[o];
	    this.ro.yinzhi = true;
            continue;
          }
	            	            if(o=='riqi'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `huiyuanfahuo/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.huiyuanfahuoCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                            ...
                                                            yinlewenjianUploadChange(fileUrls) {
                this.ruleForm.yinlewenjian = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                            	addEditStyleChange() {
	  this.$nextTick(()=>{
